...
{{--                                {{print_r($foods['photo'])}}--}}
                                <img src="{{--{{asset('storage/images/'.$product->imagename)}}--}}
                                {{--https://nix-tag-images.s3.amazonaws.com/452_thumb.jpg--}}
                                {{$photos['thumb']}}" alt=""   class = "m-5 w-20 max-w-xs">
                            ...
                            <p class="text-gray-500 text-base mt-2">
                                ...
                                <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
                                       id="serving_unit" name="serving_unit" type="text" value="{{$i['serving_unit']}}">
                            </p>
                            <p class="text-gray-500 text-base mt-2">
                                <label for="serving_size">Serving Size</label>
                                <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
                                       id="serving_size" name="serving_size" type="text" value="{{$i['serving_qty']}} {{$i['serving_unit']}}">
                            </p>
                            <p class="text-gray-500 text-base mt-2">
                            ...
                            <p class="text-gray-500 text-base mt-2">
                                ...
                                <textarea class="scrollabletextbox appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
